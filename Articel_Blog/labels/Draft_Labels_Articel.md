# LNbits Introducing Labels  
### A new way to sort, group, and understand your payments easily.
...
Think of it as little organizers for your payment world. They help you group, filter, track, and review Lightning transactions in a way that give you more power.
...
**A Shop Owner With Multiple Categories**
...
Every time you create an invoice, you choose the matching label.Later, you filter by label and instantly see:  
  ...
  -	how your normal offline store performed.  

 > Make business decisions based on clean data without any extra tools.
...
After the event, you filter all transactions by the label. Boom — you instantly see:  
  ...
  -	the exact list of every payment tied to that meetup.  
...
LNbits has always focused on being simple, modular, and approachable. Labels add the missing piece.  
  ...
  -	Stronger workflow for shops and creators
  -	Easy filterable CSV export.  

All without needing external management tools.

---  

### Explore more about LNBits:  

- 📦 **LNbits Extensions:**  
  https://extensions.lnbits.com/  
  *(Video overview – perfect for newcomers)*  
  https://www.youtube.com/watch?v=ymq_BXN4lu0

- 🚀 **Spin up LNbits in seconds:**  
  https://lnbits.com/  
  Click **Launch** → create your wallet → start experimenting.

- **LNBits Wiki**
https://github.com/lnbits/lnbits/wiki/Powered-by-LNbits

- 💜 **Support the project:**  
  LNbits Shop — every purchase helps the ecosystem grow.

- 🔁 **Share or subscribe** if this content sparked an idea.  
  The more people build, the more everyone wins.
